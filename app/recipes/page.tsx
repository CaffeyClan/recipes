...
import { BookOpen, ChefHat, MessageCircle, Pencil, Plus, Search, Star, Users, Utensils } from "lucide-react";
...
function RecipeDetail({ recipe }: { recipe: Recipe }) {
  ...
  return <div className="recipe-detail">
    ...
    {recipe.notes.length > 0 && <section className="family-note"><MessageCircle aria-hidden="true" /><div><h3>Clan Notes</h3>{recipe.notes.map((note) => <p key={note}>{note}</p>)}</div></section>}
